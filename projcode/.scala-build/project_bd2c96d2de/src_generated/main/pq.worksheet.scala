...
object `pq.worksheet` {
/*<script>*/import stainless.collection._
...
/*</script>*/ /*<generated>*/
def args = `pq.worksheet_sc`.args$
  /*</generated>*/
}

object `pq.worksheet_sc` {
  ...
  def main(args: Array[String]): Unit = {
    args$set(args)
    `pq.worksheet`.hashCode() // hasCode to clear scalac warning about pure expression in statement position
  }
}
